public class InternalButtons {
    ...
    void pressButton(int destinationButton,ElevatorCar elevatorCar){
        //1.check if destination is in the list of available floors

        //2. submit the request to the InternalDispatcher
        dispatcher.submitInternalRequest(destinationButton,elevatorCar);
    }
}
